...
define('EasySketch/Sketch',["./EasySketch", "./EventManager", "./Util"], function (EasySketch, EventManager, Util) {
    ...
    EasySketch.Sketch.prototype = {
         ...
         *
         * @returns {{color: (string|AbstractAddon.Undo._currentLine.color|color|EasySketch.Sketch.options.color|string|CSSStyleDeclaration.color), width: (number|AbstractAddon.Undo._currentLine.width|width|EasySketch.Sketch.options.width|Number|string|*), alpha: (number|alpha|EasySketch.Sketch.options.alpha)}}
         */
